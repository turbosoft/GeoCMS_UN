...
<!-- 	<button id="aesBtn" onclick="getAes('D');">DES BTN</button> -->
	...
	<div style="height: 100px; float: left; max-width: 390px;">
		...
		<div id="navbarMenu" style="float: right;height: 85px; min-width: 17px; z-index: 50; background: white; position: relative; margin:10px; width:480px; left:304%; top:-92px;">
			<div id="topMenu" style="height: 100px; float: left; width:100%;"></div>
	...
	<!-- map -->
	<div id="image_map" style="height:100%; position:absolute; left:420px; background-color: #EAEAEA; z-index: 10;">
		<jsp:include page="sub/map/image_googlemap.jsp"/>
	</div>
	
	<!-- left list table -->
	<div id="image_list" style="width:420px; top:100px; position:absolute; display:block; z-index: 1">
	...
	<!-- my projects table -->
	<div id="myProject_list" style="width: 420px; height:88%; position: absolute; top: 100px; display: none; z-index: 490; background-color:white;">
