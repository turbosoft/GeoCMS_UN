...
<div id="LoginDig">
	<table id='login_table' style="font-size: 13px;" width="100%;" class="loginCls" onKeyPress='submitLogin(event);'>
		<tbody>
			<tr>
				<th>ID</th>
				<td>
				...
				<td rowspan="2" style="text-align:center;">
					<button onclick='loginUser();' id="loginBtn" class="radiusBtn5" >LOGIN</button>
				</td>
			</tr>
			<tr>
				<th>PASS</th>
			...
			<tr>
				<td colspan='3'align='center'>
					<button onclick='fnJoin();' id="joinBtn" class="radiusBtn5">JOIN</button>
					<button onclick='fnFind();' id="idpassBtn" class="radiusBtn5">ID/PASS SEARCH</button>
				</td>
			</tr>
		</tbody>
	</table>
