...
function addGpxFileBtn(){
	...
	if(gpxFileCnt > 1){
		htmlStr += '<input type="button" value="Remove" onclick="removeGpxFileBtn('+ gpxFileCnt +');" style="border-radius: 2px; border: none; font-size: 14px; padding: 3px 8px; display: inline-block; background: #6D808F; color: white;">';
	}
	htmlStr += '</div>';
...
function fnVideoMainChange(tType){
	...
	$('.videoSelTopDiv').css('background-color','#ffffff');
	if(tType != null){
		nowVideoType = tType;
		fnFileClear();
		$('#'+ nowVideoType + '_video_area').css('display','block');
		$('#videoSelTopDiv_'+tType).css('background-color','#F2F3F5');
	}
}
	...
	if(nowVideoType == 'm'){
		...
		$.each($('.file_input_hidden_video_m'),function(idx,val){
			...
			if(videoGpsName != null && videoGpsName != undefined && videoGpsName != ''){
				...
				htmlStr += '<label class="container">'+ videoGpsName;
			...
			<div style="width:250px;float:left;">
				<div style="float:left;">
					<label class="container">Image 
						<input type="radio" id="showImage" name="showRadio" onclick="changeShow('Image')">
						<span class="checkmark"></span>
					</label>
				</div>
				<div style="float:left;">
					<label class="container">Video 
						<input type="radio" id="showVideo" name="showRadio">
						<span class="checkmark"></span>
					</label>
				</div>
			</div>
...
<!-- 	</tr> -->
	...
	<tr>
		<td  colspan="2">
			<div id="videoSelTopDiv_s" class="videoSelTopDiv" style="float: left;width: 100px;height: 28px;text-align: center; background-color: #F2F3F5;" onclick="fnVideoMainChange('s');return;">
		...
		<td height="25" colspan="2">		
			...
			<div id="m_video_area" class="video_area" style="display:none;">
				...
				<div class="file_input_div_video" id="file_input_div_3">
					...
					<input type="button" value="Remove" onclick="removeVideoFileBtn(3);" style="margin-left: 210px; border-radius: 2px; border: none; font-size: 14px; padding: 3px 8px; display: inline-block; background: #6D808F; color: white;">
				</div>
				<div class="file_input_div_video" id="file_input_div_4">
					...
					<input type="button" value="Remove" onclick="removeVideoFileBtn(4);" style="margin-left: 210px; border-radius: 2px; border: none; font-size: 14px; padding: 3px 8px; display: inline-block; background: #6D808F; color: white;">
				</div>
				<div class="file_input_div_video" id="file_input_div_5">
					...
					<input type="button" value="Remove" onclick="removeVideoFileBtn(5);" style="margin-left: 210px; border-radius: 2px; border: none; font-size: 14px; padding: 3px 8px; display: inline-block; background: #6D808F; color: white;">
				</div>
			</div>
		</td>
	</tr>
		...
		<td height="25" colspan="2">
			<div style="clear: both; padding:10px;">
				<div style="margin-left:3px; float:left;">
					<label class="container">No coordinates 
						<input type="radio" id="fileTypeRadio_1" name="fileTypeRadio" value="1" onclick="fnGpsTypeChange(this);" checked="checked"/>
						<span class="checkmark"></span>
					</label>
				</div>
				<div style="margin-left:3px; float:left;">
					<label class="container">GPX
						<input type="radio" id="fileTypeRadio_2" name="fileTypeRadio" value="2" onclick="fnGpsTypeChange(this);"/>
						<span class="checkmark"></span>
					</label>
				</div>
				<div style="margin-left:3px; float:left;">
					<label class="container">SRT
						<input type="radio" id="fileTypeRadio_3" name="fileTypeRadio" value="3" onclick="fnGpsTypeChange(this);"/>
						<span class="checkmark"></span>
					</label>
				</div>
				<br/>
				<br/>
				<div style="margin-left:3px; float:left;">
					<label class="container">Video coordinates 
						<input type="radio" id="fileTypeRadio_4" name="fileTypeRadio" value="4" onclick="fnGpsTypeChange(this);"/>
						<span class="checkmark"></span>
					</label>
				</div>
				<div style="margin-left:3px; float:left;">
					<label class="container">Video coordinates (Sony Dash cam)
						<input type="radio" id="fileTypeRadio_5" name="fileTypeRadio" value="5" onclick="fnGpsTypeChange(this);"/>
						<span class="checkmark"></span>
					</label>
				</div>
			</div>
			...
			<div id="gps_file_add_area" style="display: none;">
				<input type="button" value="Add" onclick="addGpxFileBtn();" style="border-radius: 2px; border: none; font-size: 14px; padding: 5px 10px; display: inline-block; background: #297ACC; color: white; margin-left:350px;">
				<div id="gps_area">
